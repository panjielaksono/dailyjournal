                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            ...
                            <input type="text" class="form-control" name="alt" placeholder="Tuliskan alt Gambar" value="<?= $row["alt"] ?>" required>
                        </div>
                        <div class="mb-3">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <form method="post" action="" enctype="multipart/form-data">
                    <div class="modal-body">
                        <div class="mb-3">
                            <label for="formGroupExampleInput" class="form-label">Yakin akan menghapus Gambar "<strong><?= $row["alt"] ?></strong>"?</label>
                            <input type="hidden" name="id" value="<?= $row["id"] ?>">
